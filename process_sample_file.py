...
def process_sample_file_from_path(sample_file_path: Path, output_file_path: Path):
...
def process_sample_file_rows(sample_file: Iterable[str], sample_size: int, output_file_path: Path):
...
def parse_arguments():
    ...
    parser.add_argument('output_file_path', help='path to write the processed file to', type=Path)
